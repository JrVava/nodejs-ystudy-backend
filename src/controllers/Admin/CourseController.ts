        ...
        try {
            ...
            if (courseCmsData) {
                ...
                if (effectiveCourseType === 'General') {
                    ...
                    console.log("overview", courseCmsData.overview);
                    console.log("salary", courseCmsData.salary);
                    console.log("funding", courseCmsData.funding);
                    console.log("study", courseCmsData.study);
